...
```{r alnus-data-plot, dpi=300, dev=c('png','postscript','tiff')}
library("analogue")
...
```{r, marion-plot, fig.height=6, fig.width=6, echo=TRUE, message=FALSE, warning=FALSE, dpi=300, dev=c('png','postscript','tiff')}
...
```{r map-pinus-example, echo = TRUE, message = FALSE, warning = FALSE, dpi=300, dev=c('png','postscript','tiff')}
map <- map_data('world')
...
```{r pinus-recal-plot, echo = TRUE, fig.width = 7, fig.height = 4, warning = FALSE, dpi=300, dev=c('png','postscript','tiff')}
...
```{r mammal-example-plot, fig.width = 7, fig.height = 4, echo = TRUE, warning = FALSE, dpi=300, dev = c('png','postscript','tiff')}
