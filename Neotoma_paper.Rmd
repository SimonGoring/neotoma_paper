...
df <- plyr::unrowname(western.dl[[1]]$taxon.list)
...
```{r map-pinus-example, echo = TRUE, message=FALSE, warning = FALSE, tidy = FALSE}
map <- map_data('world')
...
```{r pinus-stratiplot, fig.height=3, fig.width=6, echo = TRUE, message=FALSE, warning = FALSE, tidy = FALSE}
...
```{r pinus-first-occur, echo = TRUE, fig.width = 6, fig.height  =  3, warning = FALSE, tidy = FALSE}
...
```{r mammal-example-compile, echo = TRUE, message = FALSE, warning = FALSE, tidy = FALSE}
...
```{r mammal-example-plot, fig.width = 7, fig.height = 4, echo = TRUE, warning = FALSE, tidy = FALSE}
